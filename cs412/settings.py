...
SECRET_KEY = "django-insecure-8*w_z4$*wl!pq)+0^1pc5i1=)k0!e0b&2&tbcogkomp_(_*^xp"
...
ALLOWED_HOSTS = [
    "*",
    "cs-webapps.bu.edu",  # Added to allow cs website to host
]
...
TEMPLATES = [
    {
        ...
        "APP_DIRS": True,
        "OPTIONS": {
            "string_if_invalid": "WARNING: {{%s}} not a valid contet variable.",
            "context_processors": [
...
# declarations to ref static files
...
if socket.gethostname() == CS_DEPLOYMENT_HOSTNAME:
    STATIC_URL = "/llouise/static/"
    MEDIA_URL = "/llouise/media/"
